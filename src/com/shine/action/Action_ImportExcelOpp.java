...
public class Action_ImportExcelOpp extends ActionSupport {
	...
	public String importExcel(){
		...
		try {
			...
			System.out.println("批量导入失败:" + e.getMessage());
			map.put("result", "fail");
		}
