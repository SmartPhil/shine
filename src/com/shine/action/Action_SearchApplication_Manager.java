...
public class Action_SearchApplication_Manager extends ActionSupport {
	...
	public String search(){
		...
		try {
			...
			List<Application> applications = applicatioinDao.getApplicationByDateAndApplicant(begin, end, username);
